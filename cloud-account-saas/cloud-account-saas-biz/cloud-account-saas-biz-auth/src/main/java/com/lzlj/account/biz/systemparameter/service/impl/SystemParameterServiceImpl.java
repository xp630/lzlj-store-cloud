package com.lzlj.account.biz.systemparameter.service.impl;
...
import com.lzlj.account.biz.systemparameter.dao.SystemParameterDao;
import com.lzlj.account.biz.systemparameter.dto.CreateSystemParameterDTO;
import com.lzlj.account.biz.systemparameter.dto.SystemParameterDTO;
import com.lzlj.account.biz.systemparameter.dto.SystemParameterQueryDTO;
import com.lzlj.account.biz.systemparameter.dto.UpdateSystemParameterDTO;
import com.lzlj.account.biz.systemparameter.entity.SystemParameter;
...
public class SystemParameterServiceImpl implements SystemParameterService {
    ...
    public Long create(CreateSystemParameterDTO dto) {
        ...
        cacheService.invalidateSystemParameters();
    ...
    public List<SystemParameterDTO> list() {
        List<SystemParameterDTO> cached = cacheService.getSystemParameters();
        if (cached != null) {
            return cached;
        }
        LambdaQueryWrapper<SystemParameter> wrapper = new LambdaQueryWrapper<>();
        ...
        List<SystemParameterDTO> result = params.stream().map(this::convertToDTO).collect(Collectors.toList());
        if (!result.isEmpty()) {
            cacheService.setSystemParameters(result);
        }
        return result;
    }
