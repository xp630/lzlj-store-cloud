...
public class SaasOperationLogController {
    ...
    @PostMapping("/page")
    public Result<PageResult<OperationLogDTO>> page(@RequestBody PageRequest<OperationLogQueryDTO> pageRequest) {
        return Result.success(logService.pageOperationLog(pageRequest));
    }
}
